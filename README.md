...
code/
├── agents/
│   ├── data_agent/         ← implements data extract agent
│   ├── ml_agent/           ← Implements planning agent
│   ├── dv_agent/           ← Implements Visualization agents
│
...
│       ├── mcp_*.log
│
├── student_ui/             ← User Interface
│   └── app.py 
│
├── data/                   ← Source data
│   └── api.txt
└── artifacts/              ← Processed results after User Query
    └── user_results/
